        ...
        <div className="bg-gray-100 p-4 rounded-lg mb-4 ">
          <div className="flex items-start space-x-6">
            <div className="relative">
              <img
                src="https://media.vogue.co.uk/photos/682db95ee235579a4722634c/2:3/w_1920,c_limit/GettyImages-2216112138.jpg"
                alt="profile"
            ...
            <div className="flex-1">
              ...
              <p className="text-l text-black mb-4">blackwidow@gmail.com</p>
            </div>
          </div>
